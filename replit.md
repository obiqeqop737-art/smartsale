...
- **Intelligence Radar**: News cards with detail dialog, AI insights, favorite/share (to users via notification), daily AI auto-update at 12:00 (scheduler), admin manual trigger, sidebar "NEW" badge on updates
