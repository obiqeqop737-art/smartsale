...
export function TopBar({ user }: TopBarProps) {
  ...
  return (
    <div className="h-12 border-b border-blue-500/10 bg-slate-950/40 backdrop-blur-sm flex items-center justify-between px-4 md:px-6 shrink-0" data-testid="top-bar">
      ...
      <div className="flex items-center gap-2">
        <div className={`flex items-center transition-all duration-300 ${searchOpen ? "w-48 md:w-64" : "w-8"}`}>
          {searchOpen ? (
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full h-8 pl-8 pr-3 rounded-lg text-xs glass-input text-slate-300 placeholder:text-slate-600"
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="glass-dialog border-blue-500/20 w-48">
            ...
            <DropdownMenuItem asChild className="text-slate-400 hover:text-blue-300 focus:text-blue-300 focus:bg-blue-500/10 cursor-pointer">
